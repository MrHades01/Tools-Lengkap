...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  MrHades01  "$i"                  "
echo $i""$pu"  WhatsApp  :  --------------"$i"              "
echo $i""$pu"  GMAIL     :  noxtar.side@gmail.com"$i"   "
echo $i""$pu"  YOUTUBE   :  Hades GTPS"$i"               "
echo $i""$pu"  INSTAGRAM :  @hadesgtps_"$i"               "
echo $i""$pu"  INSTAGRAM :  @hadesgtps_"$i"          "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" NUKED"
echo $ku"YouTube  :"$i" Hades GTPS"
echo $ku"WhatsApp :"$i" ----------"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Hades GTPS }"
exit
fi
